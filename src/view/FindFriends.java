...
public class FindFriends extends javax.swing.JFrame {
    ...
    public void getData() {
        ...
        for (int i = 0; i < FileLoader.users.size(); i++) {
            if(!FileLoader.users.get(i).getUserName().equals(Controller.currentUser.getUserName()))
            x.addElement(FileLoader.users.get(i).getUserName());
        }
    ...
    public void filterList(String subString) {
        ...
        for (int i = 0; i < FileLoader.users.size(); i++) {
            if (((FileLoader.users.get(i).getUserName().toLowerCase().trim()).startsWith(subString.toLowerCase().trim())
                    || (FileLoader.users.get(i).getUserName().toLowerCase().trim()).contains(subString.toLowerCase().trim()))
                    && !FileLoader.users.get(i).getUserName().equals(Controller.currentUser.getUserName())) {
                y.addElement(FileLoader.users.get(i).getUserName());
            }
        }
