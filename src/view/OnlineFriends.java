...
public class OnlineFriends extends javax.swing.JFrame {
    ...
    public OnlineFriends() {
       ...
       onlineFriends= Finder.loadOnlineFriends();
        this.getData();
    }
    public void getData() {

        for (int i = 0; i < onlineFriends.size(); i++) {
            if (!onlineFriends.get(i).getUserName().equals("1")) {
                x.addElement(onlineFriends.get(i).getUserName());
            }
        }
    ...
    public void filterList(String subString) {
        ...
        for (int i = 0; i < onlineFriends.size(); i++) {
            if (((onlineFriends.get(i).getUserName().toLowerCase().trim()).startsWith(subString.toLowerCase().trim())
                    || (onlineFriends.get(i).getUserName().toLowerCase().trim()).contains(subString.toLowerCase().trim()))
                    && !onlineFriends.get(i).getUserName().equals(Controller.currentUser.getUserName())) {
                y.addElement(onlineFriends.get(i).getUserName());
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/online.png"))); // NOI18N
